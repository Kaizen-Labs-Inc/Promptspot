...
models_data = [
  {name: "gpt-4-0125-preview", description: "The latest GPT-4 model intended to reduce cases of 'laziness' where the model doesn’t complete a task.", enabled: true, model_type: "chat"},
